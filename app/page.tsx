...
import { Check, MapPin, Plane, Users, Clock, Star, MessageCircle, Globe, Zap, Bell, Shield, Heart, Award, Timer, Crown, Sparkles, Diamond, Compass, Camera, Map } from 'lucide-react'
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 sm:py-16 md:py-20 lg:py-28 xl:py-36 relative overflow-hidden">
          ...
          >
            {/* Elegant Overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-white/85 via-white/70 to-blue-50/60"></div>
